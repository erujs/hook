...
import { stateProfile } from "../../features/profile/profileSlice";
...
export const ProfileDetails = ({ profile }) => {
  ...
  return (
    <>
      ...
      <div className="py-4 lg:w-full mx-auto flex flex-wrap justify-start">
...
export const ProfileCard = () => {
  const { profile } = useAppSelector(stateProfile);
  ...
  return (
    <div className="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-16 lg:my-32 lg:my-0">
      <div className="w-full lg:w-2/5 shadow-xl">
        <img
          src={profile.picture}
          className="hidden lg:block object-cover min-h-[600px]"
        />
      </div>
